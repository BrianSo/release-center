...
if (fs_1.default.existsSync(".env")) {
    ...
    logger_1.default.debug("Using .env.default file to supply config environment variables");
    dotenv_1.default.config({ path: ".env.default" }); // you can delete this after you create your own .env file!
}
